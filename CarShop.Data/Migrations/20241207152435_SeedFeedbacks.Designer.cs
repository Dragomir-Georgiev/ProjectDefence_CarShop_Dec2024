...
namespace CarShop.Data.Migrations
{
    ...
    [Migration("20241207152435_SeedFeedbacks")]
            ...
            modelBuilder.Entity("CarShop.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "be4f29c3-591c-456b-a034-2b48c1746875",
                            Email = "testuser123@gmail.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "TESTUSER123@GMAIL.COM",
                            NormalizedUserName = "USER",
                            PasswordHash = "AQAAAAIAAYagAAAAELjpNCah0NefiiM+g33W+ozcLKRUGnWbrtP3/7PQfJUtFizBiODW5Hb7QVfjlqjykg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "a25f4f25-6564-4df1-8e08-9edeea589012",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "2d5be83f-4b71-44e7-8d05-a61c2f208970",
                            Email = "dragomir@yahoo.ca",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "DRAGOMIR@YAHOO.CA",
                            NormalizedUserName = "DRAGOMIR",
                            PasswordHash = "AQAAAAIAAYagAAAAEAf50lJVHHJe3Kr2qvntX4CPRuF6nqwf3uzt14OrSYaDbuYWmbdPlYSMDeFG3cJ+MA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "45f0bfdc-3f16-42bc-a9a3-fb92ad292b56",
                            TwoFactorEnabled = false,
                            UserName = "Dragomir"
                        },
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "e7e6520c-ce64-4054-b455-1f618851f7f2",
                            Email = "admin@example.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@EXAMPLE.COM",
                            NormalizedUserName = "АDMIN",
                            PasswordHash = "AQAAAAIAAYagAAAAEC5gDY5390cXhrzHexuixz0L2gQXAPjmUFkoLsXIwCb2QFR0Hy2SSLsQPrVi7NT+hw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "ee886ccb-f537-45be-a208-195104eeed9c",
                            TwoFactorEnabled = false,
                            UserName = "Admin"
                        });
                });
            ...
            modelBuilder.Entity("CarShop.Data.Models.DamageReport", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ReportedDate = new DateTime(2024, 12, 4, 15, 24, 34, 302, DateTimeKind.Utc).AddTicks(2805)
                        },
                        new
                        {
                            ...
                            ReportedDate = new DateTime(2024, 11, 27, 15, 24, 34, 302, DateTimeKind.Utc).AddTicks(2824)
                        },
                        new
                        {
                            ...
                            ReportedDate = new DateTime(2024, 12, 2, 15, 24, 34, 302, DateTimeKind.Utc).AddTicks(2828)
                        },
                        new
                        {
                            ...
                            ReportedDate = new DateTime(2024, 11, 22, 15, 24, 34, 302, DateTimeKind.Utc).AddTicks(2831)
                        },
                        new
                        {
                            ...
                            ReportedDate = new DateTime(2024, 11, 30, 15, 24, 34, 302, DateTimeKind.Utc).AddTicks(2840)
                        });
                });
            ...
            modelBuilder.Entity("CarShop.Data.Models.Feedback", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c4fea403-c09e-4418-8cf9-91c63cee8c4f"),
                            ApplicationUserId = new Guid("7d98badc-6c8c-4588-a4f5-d4a43ca9d741"),
                            CarId = new Guid("29480900-2b63-4503-8818-647fde2a47e5"),
                            Comment = "Great car, smooth ride!",
                            FeedbackDate = new DateTime(2024, 11, 29, 15, 24, 34, 302, DateTimeKind.Utc).AddTicks(4677),
                            Rating = 5
                        },
                        new
                        {
                            Id = new Guid("e871ea89-16a7-47eb-a874-38c32dd1b0fd"),
                            ApplicationUserId = new Guid("4c2d88cd-675a-4904-a431-23a043e8313e"),
                            CarId = new Guid("29480900-2b63-4503-8818-647fde2a47e5"),
                            Comment = "The car was decent but had a few issues.",
                            FeedbackDate = new DateTime(2024, 12, 1, 15, 24, 34, 302, DateTimeKind.Utc).AddTicks(4689),
                            Rating = 2
                        });
                });
