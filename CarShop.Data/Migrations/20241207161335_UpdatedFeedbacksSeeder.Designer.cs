...
namespace CarShop.Data.Migrations
{
    ...
    [Migration("20241207161335_UpdatedFeedbacksSeeder")]
    partial class UpdatedFeedbacksSeeder
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CarShop.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "e19faa63-31ad-4fcd-995f-7fcb6ba765a6",
                            Email = "testuser123@gmail.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "TESTUSER123@GMAIL.COM",
                            NormalizedUserName = "USER",
                            PasswordHash = "AQAAAAIAAYagAAAAEMZ7u6/gnIdRoSP5KEuIit3SShEAniLKN3XZJuetxnbRlgXe9TZB8WVH6IoFc7qP1w==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "65729299-f69c-470a-9e1d-10fec9faa42f",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "49900b7d-6f42-4b97-8694-b076034b8c36",
                            Email = "dragomir@yahoo.ca",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "DRAGOMIR@YAHOO.CA",
                            NormalizedUserName = "DRAGOMIR",
                            PasswordHash = "AQAAAAIAAYagAAAAEOMuVS+tpWdXQdVsnk2yuH6SM2NQlsuayrOqieuhVSSZrhUrcStjHlyscU1dg6dG1A==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "29e8e30d-18d7-4055-8876-780befa13193",
                            TwoFactorEnabled = false,
                            UserName = "Dragomir"
                        },
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "1ab29a5f-50c0-4d4b-bf29-f3a9504605bf",
                            Email = "admin@example.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@EXAMPLE.COM",
                            NormalizedUserName = "АDMIN",
                            PasswordHash = "AQAAAAIAAYagAAAAEGxj23yvD8Svw4xXab6HZ+UVoOHhpr9l0U7XlUWRvJpFoOeHQBK3gIJYoFmhcDaAfw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "1efa990a-cf25-4983-aadc-5d1436b659cc",
                            TwoFactorEnabled = false,
                            UserName = "Admin"
                        });
                });
            ...
            modelBuilder.Entity("CarShop.Data.Models.DamageReport", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ReportedDate = new DateTime(2024, 12, 4, 16, 13, 34, 543, DateTimeKind.Utc).AddTicks(3964)
                        },
                        new
                        {
                            ...
                            ReportedDate = new DateTime(2024, 11, 27, 16, 13, 34, 543, DateTimeKind.Utc).AddTicks(3986)
                        },
                        new
                        {
                            ...
                            ReportedDate = new DateTime(2024, 12, 2, 16, 13, 34, 543, DateTimeKind.Utc).AddTicks(3990)
                        },
                        new
                        {
                            ...
                            ReportedDate = new DateTime(2024, 11, 22, 16, 13, 34, 543, DateTimeKind.Utc).AddTicks(3992)
                        },
                        new
                        {
                            ...
                            ReportedDate = new DateTime(2024, 11, 30, 16, 13, 34, 543, DateTimeKind.Utc).AddTicks(3995)
                        });
                });
            ...
            modelBuilder.Entity("CarShop.Data.Models.Feedback", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9f802f93-1b20-401c-9c5e-adb2b51597f3"),
                            ApplicationUserId = new Guid("7d98badc-6c8c-4588-a4f5-d4a43ca9d741"),
                            CarId = new Guid("29480900-2b63-4503-8818-647fde2a47e5"),
                            Comment = "Great car, smooth ride!",
                            FeedbackDate = new DateTime(2024, 11, 29, 16, 13, 34, 543, DateTimeKind.Utc).AddTicks(5452),
                            Rating = 5
                        },
                        new
                        {
                            Id = new Guid("2c473f9e-326e-4f71-9810-fbff216fdc6f"),
                            ApplicationUserId = new Guid("4c2d88cd-675a-4904-a431-23a043e8313e"),
                            CarId = new Guid("29480900-2b63-4503-8818-647fde2a47e5"),
                            Comment = "The car was decent but had a few issues.",
                            FeedbackDate = new DateTime(2024, 12, 1, 16, 13, 34, 543, DateTimeKind.Utc).AddTicks(5470),
                            Rating = 2
                        });
                });
            ...
            modelBuilder.Entity("CarShop.Data.Models.Rental", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2024, 12, 17, 16, 13, 34, 543, DateTimeKind.Utc).AddTicks(6567),
                            StartDate = new DateTime(2024, 12, 14, 16, 13, 34, 543, DateTimeKind.Utc).AddTicks(6565),
                            TotalCost = 4541.84m
                        },
                        new
                        {
                            ...
                            EndDate = new DateTime(2024, 12, 14, 16, 13, 34, 543, DateTimeKind.Utc).AddTicks(6577),
                            StartDate = new DateTime(2024, 12, 10, 16, 13, 34, 543, DateTimeKind.Utc).AddTicks(6576),
                            TotalCost = 2151.95m
                        },
                        new
                        {
                            ...
                            EndDate = new DateTime(2024, 12, 10, 16, 13, 34, 543, DateTimeKind.Utc).AddTicks(6586),
                            StartDate = new DateTime(2024, 12, 8, 16, 13, 34, 543, DateTimeKind.Utc).AddTicks(6585),
                            TotalCost = 216m
                        });
                });
